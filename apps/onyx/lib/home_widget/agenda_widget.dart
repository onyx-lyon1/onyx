...
String encodeDays(List<Day> days, DateTime today, int daysLimit, List<int> disabledDays) {
...
void updateEvents(List<Day> days, SettingsModel settings) {
  ...
  String encodedDays = encodeDays(days, now, Res.agendaWidgetDaysStored, settings.agendaDisabledDays);
  HomeWidget.saveWidgetData<String>('agenda_events', encodedDays);
  HomeWidget.saveWidgetData<String>('agenda_last_update', now.toLocal().toIso8601String());
