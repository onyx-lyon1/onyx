                      ...
                      if (e.date != null && e.duration != null) {
                        return Event(
                          ...
                          location: AppLocalizations.of(
                            context,
                          ).examLocationPlace(e.location ?? "", e.place ?? -1),
                          start: e.date!,
