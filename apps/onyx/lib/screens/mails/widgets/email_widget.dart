...
class MailWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OpenContainer(
      ...
      openBuilder: (context, closeContainer) => MailDetailsPage(mail: email),
          ...
          leading: (context.read<EmailCubit>().state.selectedMails.isNotEmpty)
              ? Container(
                  ...
                  child: InkWell(
                    ...
                    child: Icon(
                      context.read<EmailCubit>().state.selectedMails.contains(
                            email,
                          )
                          ? Icons.check_box
              ...
              IconButton(
                ...
                icon: Icon(
                  ...
                  semanticLabel: email.isFlagged
                      ? AppLocalizations.of(context).flagedEmail(email.subject)
                      : AppLocalizations.of(
                          context,
