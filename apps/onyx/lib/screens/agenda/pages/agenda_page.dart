...
class AgendaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int weekLength = context
        .read<SettingsCubit>()
        .state
        .settings
        .agendaWeekLength;
    context.read<AgendaCubit>().miniCalendarScrollController = PageController(
      initialPage: wantedDate ~/ weekLength,
    );
    context.read<AgendaCubit>().horizontalScrollController[0] = PageController(
      initialPage: wantedDate,
    );
    context.read<AgendaCubit>().horizontalScrollController[1] = PageController(
      initialPage: wantedDate ~/ weekLength,
    );
      ...
      builder: (context, settingsState) {
        return BlocBuilder<AgendaCubit, AgendaState>(
          ...
          builder: (context, state) {
            ...
            List<ScrollController> verticalController = List.generate(
              3,
              (_) => ScrollController(),
            );
                    ...
                    if (index == 0) {
                      ...
                      if (context
                        ...
                        context
                            ...
                            .horizontalScrollController[1]
                            .jumpToPage(
                              date ~/ settingsState.settings.agendaWeekLength,
                            );
