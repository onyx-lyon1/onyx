  ...
  static final List<Day> dayListMock = [
    Day(DateTime(2022, 9, 1), [
      ...
      Event(
          ...
          name: "mockname3-2bis",
          start: DateTime(2022, 9, 1, 10, 45),
          end: DateTime(2022, 9, 1, 11, 45),
          eventLastModified: DateTime(2022, 9, 1)),
    ]),
    Day(DateTime(2022, 9, 2), [
      Event(
          ...
          name: "mockname4",
          start: DateTime(2022, 9, 2, 11),
          end: DateTime(2022, 9, 2, 12),
          eventLastModified: DateTime(2022, 9, 2)),
      Event(
          location: "ISTIL",
          description: "mockDescription5",
          teacher: "mockTeacher5",
          name: "mockname5",
          start: DateTime(2022, 9, 2, 12),
          end: DateTime(2022, 9, 2, 13),
          eventLastModified: DateTime(2022, 9, 2)),
      Event(
          location: "Forel",
          ...
          name: "mockname6",
          start: DateTime(2022, 9, 2, 13),
          end: DateTime(2022, 9, 2, 14),
          eventLastModified: DateTime(2022, 9, 2)),
    ]),
    Day(DateTime(2022, 9, 3), [
      Event(
          ...
          name: "mockname7",
          start: DateTime(2022, 9, 3, 14),
          end: DateTime(2022, 9, 3, 15),
          eventLastModified: DateTime(2022, 9, 3)),
      Event(
          location: "Thémis",
          description: "mockDescription8",
          teacher: "mockTeacher8",
          name: "mockname8",
          start: DateTime(2022, 9, 3, 15),
          end: DateTime(2022, 9, 3, 16),
          eventLastModified: DateTime(2022, 9, 3)),
      Event(
          location: "Nautibus",
          ...
          name: "mockname9",
          start: DateTime(2022, 9, 3, 16),
          end: DateTime(2022, 9, 3, 17),
          eventLastModified: DateTime(2022, 9, 3)),
    ]),
    for (int i = 4; i < 300; i++)
      Day(
