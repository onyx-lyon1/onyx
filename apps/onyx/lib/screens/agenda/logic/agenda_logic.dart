  ...
  static final List<Day> dayListMock = [
    Day(DateTime(2023, 9, 1), [
      Event(
          ...
          name: "mockname1",
          start: DateTime(2023, 9, 1, 8),
          end: DateTime(2023, 9, 1, 9),
          eventLastModified: DateTime(2023, 9, 1)),
      Event(
          location: "Thémis",
          ...
          end: DateTime(2023, 9, 1, 10),
          eventLastModified: DateTime(2023, 9, 1)),
      Event(
          location: "Thémis",
          description: "mockDescription2-bis",
          teacher: "mockTeacher2-bis",
          name: "mockname2-bis",
          start: DateTime(2023, 9, 1, 9, 30),
          end: DateTime(2023, 9, 1, 10),
          eventLastModified: DateTime(2023, 9, 1)),
      Event(
          location: "Nautibus",
          ...
          name: "mockname3",
          start: DateTime(2023, 9, 1, 10),
          end: DateTime(2023, 9, 1, 11),
          eventLastModified: DateTime(2023, 9, 1)),
      Event(
          location: "Nautibus",
          description: "mockDescription3-bis",
          teacher: "mockTeacher3-bis",
          name: "mockname3-bis",
          start: DateTime(2023, 9, 1, 10, 30),
          end: DateTime(2023, 9, 1, 11),
          eventLastModified: DateTime(2023, 9, 1)),
      Event(
          location: "Nautibus",
          description: "mockDescription3-2bis",
          teacher: "mockTeacher3-2bis",
          name: "mockname3-2bis",
          start: DateTime(2023, 9, 1, 10, 45),
          end: DateTime(2023, 9, 1, 11, 45),
          eventLastModified: DateTime(2023, 9, 1)),
    ]),
    Day(DateTime(2023, 9, 2), [
      Event(
          location: "quai 43",
          description: "mockDescription4",
          teacher: "mockTeacher4",
          name: "mockname4",
          start: DateTime(2023, 9, 2, 11),
          end: DateTime(2023, 9, 2, 12),
          eventLastModified: DateTime(2023, 9, 2)),
      Event(
          location: "ISTIL",
          description: "mockDescription5",
          teacher: "mockTeacher5",
          name: "mockname5",
          start: DateTime(2023, 9, 2, 12),
          end: DateTime(2023, 9, 2, 13),
          eventLastModified: DateTime(2023, 9, 2)),
      Event(
          location: "Forel",
          ...
          name: "mockname6",
          start: DateTime(2023, 9, 2, 13),
          end: DateTime(2023, 9, 2, 14),
          eventLastModified: DateTime(2023, 9, 2)),
    ]),
    Day(DateTime(2023, 9, 3), [
      Event(
          location: "Déambu",
          description: "mockDescription7",
          teacher: "mockTeacher7",
          name: "mockname7",
          start: DateTime(2023, 9, 3, 14),
          end: DateTime(2023, 9, 3, 15),
          eventLastModified: DateTime(2023, 9, 3)),
      Event(
          location: "Thémis",
          description: "mockDescription8",
          teacher: "mockTeacher8",
          name: "mockname8",
          start: DateTime(2023, 9, 3, 15),
          end: DateTime(2023, 9, 3, 16),
          eventLastModified: DateTime(2023, 9, 3)),
      Event(
          location: "Nautibus",
          ...
          name: "mockname9",
          start: DateTime(2023, 9, 3, 16),
          end: DateTime(2023, 9, 3, 17),
          eventLastModified: DateTime(2023, 9, 3)),
    ]),
    for (int i = 3; i < 300; i++)
      Day(
