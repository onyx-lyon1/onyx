      ...
      builder: (context, state) {
        List<DragAndDropList> contents = [
          DragAndDropList(
            ...
            header: Padding(
              padding: EdgeInsets.only(top: 2.h, left: 4.w, bottom: 0.8.h),
              child: Text(
        ...
        return DragAndDropLists(
          ...
          itemDivider: const Divider(height: 4, color: Colors.transparent),
          listDividerOnLastChild: false,
          listDivider: Divider(height: 3.h, color: Colors.transparent),
