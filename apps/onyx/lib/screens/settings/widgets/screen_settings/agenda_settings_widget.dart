              ...
              TextSwitchWidget(
                ...
                onChanged: (bool b) {
                  context.read<SettingsCubit>().modify(
                      settings:
                          settings.copyWith(calendarUpdateNotification: b));
                },
              ),
            TextSwitchWidget(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        onTap: () => context.read<SettingsCubit>().modify(
                            settings:
                                settings.copyWith(agendaWeekReference: 8)),
                        child: Center(
                        ...
                        if (settings.agendaDisabledDays.length == 6) {
                          ...
                          if (settings.agendaWeekReference == rawI) {
                            for (var rawj = 1; rawj < 8; rawj++) {
                              ...
                              if (!settings.agendaDisabledDays
                                      .contains(j + 1) &&
                                  j != rawI) {
                                context.read<SettingsCubit>().modify(
                                        settings: settings.copyWith(
