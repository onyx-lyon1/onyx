...
class EventMapper extends ClassMapperBase<Event> {
  ...
  static DateTime _$eventLastModified(Event v) => v.eventLastModified;
  static const Field<Event, DateTime> _f$eventLastModified =
      Field('eventLastModified', _$eventLastModified);
  static dynamic _$menuCrous(Event v) => v.menuCrous;
  static const Field<Event, dynamic> _f$menuCrous =
      Field('menuCrous', _$menuCrous, opt: true);
  ...
  final Map<Symbol, Field<Event, dynamic>> fields = const {
    ...
    #start: _f$start,
    #end: _f$end,
    #eventLastModified: _f$eventLastModified,
  ...
  static Event _instantiate(DecodingData data) {
    return Event(
        ...
        eventLastModified: data.dec(_f$eventLastModified),
...
class _EventCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Event, $Out>
  ...
  $R call(
      ...
      $apply(FieldCopyWithData({
        ...
        if (end != null) #end: end,
        if (eventLastModified != null) #eventLastModified: eventLastModified,
  ...
  Event $make(CopyWithData data) => Event(
      ...
      eventLastModified:
          data.get(#eventLastModified, or: $value.eventLastModified),
