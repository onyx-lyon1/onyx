  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            DayMapper.ensureInitialized().isValueEqual(this as Day, other));
  }
...
class _DayCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Day, $Out>
  ...
  ListCopyWith<$R, Event, EventCopyWith<$R, Event, Event>> get events =>
      ListCopyWith($value.events, (v, t) => v.copyWith.$chain(t),
          (v) => call(events: v));
  @override
  $R call({DateTime? date, List<Event>? events}) => $apply(FieldCopyWithData(
      {if (date != null) #date: date, if (events != null) #events: events}));
  @override
  Day $make(CopyWithData data) => Day(
      data.get(#date, or: $value.date), data.get(#events, or: $value.events));
