...
class StudentColloscopeMapper extends ClassMapperBase<StudentColloscope> {
  ...
  static const Field<StudentColloscope, Student> _f$student = Field(
    'student',
    _$student,
  );
  static int _$trinomeId(StudentColloscope v) => v.trinomeId;
  static const Field<StudentColloscope, int> _f$trinomeId = Field(
    'trinomeId',
    _$trinomeId,
  );
  static List<Kholle> _$kholles(StudentColloscope v) => v.kholles;
  static const Field<StudentColloscope, List<Kholle>> _f$kholles = Field(
    'kholles',
    _$kholles,
  );

  @override
  final MappableFields<StudentColloscope> fields = const {
    #student: _f$student,
...
mixin StudentColloscopeMappable {
  ...
  StudentColloscopeCopyWith<
    StudentColloscope,
    StudentColloscope,
    StudentColloscope
  >
  get copyWith =>
      _StudentColloscopeCopyWithImpl<StudentColloscope, StudentColloscope>(
  ...
  @override
  String toString() {
    return StudentColloscopeMapper.ensureInitialized().stringifyValue(
      this as StudentColloscope,
    );
  }
  ...
  bool operator ==(Object other) {
    return StudentColloscopeMapper.ensureInitialized().equalsValue(
      this as StudentColloscope,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return StudentColloscopeMapper.ensureInitialized().hashValue(
      this as StudentColloscope,
    );
  }
}
...
extension StudentColloscopeValueCopy<$R, $Out>
  ...
  get $asStudentColloscope => $base.as(
    (v, t, t2) => _StudentColloscopeCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class StudentColloscopeCopyWith<
  $R,
  $In extends StudentColloscope,
  $Out
>
    implements ClassCopyWith<$R, $In, $Out> {
  StudentCopyWith<$R, Student, Student> get student;
  ListCopyWith<$R, Kholle, KholleCopyWith<$R, Kholle, Kholle>> get kholles;
  $R call({Student? student, int? trinomeId, List<Kholle>? kholles});
...
class _StudentColloscopeCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Student? student, int? trinomeId, List<Kholle>? kholles}) => $apply(
    FieldCopyWithData({
  ...
  StudentColloscopeCopyWith<$R2, StudentColloscope, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _StudentColloscopeCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
