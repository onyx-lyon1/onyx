...
class KholleMapper extends ClassMapperBase<Kholle> {
  ...
  static const Field<Kholle, String> _f$kholleur = Field(
    'kholleur',
    _$kholleur,
  );
  ...
  @override
  final MappableFields<Kholle> fields = const {
    #date: _f$date,
    #subject: _f$subject,
...
mixin KholleMappable {
  ...
  KholleCopyWith<Kholle, Kholle, Kholle> get copyWith =>
      _KholleCopyWithImpl<Kholle, Kholle>(this as Kholle, $identity, $identity);
  @override
  String toString() {
  ...
  bool operator ==(Object other) {
    return KholleMapper.ensureInitialized().equalsValue(this as Kholle, other);
  }
...
extension KholleValueCopy<$R, $Out> on ObjectCopyWith<$R, Kholle, $Out> {
  KholleCopyWith<$R, Kholle, $Out> get $asKholle =>
      $base.as((v, t, t2) => _KholleCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _KholleCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Kholle, $Out>
  ...
  KholleCopyWith<$R2, Kholle, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _KholleCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
