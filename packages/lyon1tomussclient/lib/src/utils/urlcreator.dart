...
class URLCreator {
  ...
  static String previousSemester(final DateTime dt) {
    final String currentSemester = (dt.month >= 1 && dt.month < 9)
        ? "Printemps"
        : "Automne";

    final String prevSemester = (currentSemester == 'Printemps')
        ? 'Automne'
        : 'Printemps';

    final int prevYear = (currentSemester == 'Printemps')
        ? dt.year - 1
        : dt.year;
  ...
  static String currentSemester(final DateTime dt) {
    final String semester = (dt.month >= 1 && dt.month < 9)
        ? "Printemps"
        : "Automne";
