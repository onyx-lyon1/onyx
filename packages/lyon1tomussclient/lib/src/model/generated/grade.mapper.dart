...
class GradeMapper extends ClassMapperBase<Grade> {
  GradeMapper._();
  ...
  static const Field<Grade, String> _f$title = Field('title', _$title);
  static String _$author(Grade v) => v.author;
  static const Field<Grade, String> _f$author = Field('author', _$author);
  static DateTime? _$date(Grade v) => v.date;
  static const Field<Grade, DateTime> _f$date = Field('date', _$date);
  static double _$position(Grade v) => v.position;
  static const Field<Grade, double> _f$position = Field('position', _$position);
  static double _$numerator(Grade v) => v.numerator;
  static const Field<Grade, double> _f$numerator = Field(
    'numerator',
    _$numerator,
    opt: true,
    def: 0.0,
  ...
  static const Field<Grade, double> _f$denominator = Field(
    'denominator',
    _$denominator,
    opt: true,
    def: 20.0,
  ...
  static const Field<Grade, int> _f$rank = Field(
    'rank',
    _$rank,
    opt: true,
    def: -1,
  ...
  static const Field<Grade, double> _f$average = Field(
    'average',
    _$average,
    opt: true,
    def: 10.0,
  ...
  static const Field<Grade, double> _f$mediane = Field(
    'mediane',
    _$mediane,
    opt: true,
    def: 10.0,
  ...
  static const Field<Grade, bool> _f$isValid = Field(
    'isValid',
    _$isValid,
    opt: true,
    def: false,
  ...
  static const Field<Grade, int> _f$groupeSize = Field(
    'groupeSize',
    _$groupeSize,
    opt: true,
    def: -1,
  ...
  static const Field<Grade, List<Grade>> _f$children = Field(
    'children',
    _$children,
    opt: true,
    def: const [],
  ...
  static const Field<Grade, double> _f$coef = Field(
    'coef',
    _$coef,
    opt: true,
    def: 1.0,
  );
  static bool _$isVisible(Grade v) => v.isVisible;
  static const Field<Grade, bool> _f$isVisible = Field(
    'isVisible',
    _$isVisible,
    mode: FieldMode.member,
  );
  static List<Object?> _$customProps(Grade v) => v.customProps;
  static const Field<Grade, List<Object?>> _f$customProps = Field(
    'customProps',
    _$customProps,
    mode: FieldMode.member,
  );
  ...
  @override
  final MappableFields<Grade> fields = const {
    #title: _f$title,
    #author: _f$author,
    #date: _f$date,
...
mixin GradeMappable {
  ...
  GradeCopyWith<Grade, Grade, Grade> get copyWith =>
      _GradeCopyWithImpl<Grade, Grade>(this as Grade, $identity, $identity);
  @override
  String toString() {
  ...
  bool operator ==(Object other) {
    return GradeMapper.ensureInitialized().equalsValue(this as Grade, other);
  }
...
extension GradeValueCopy<$R, $Out> on ObjectCopyWith<$R, Grade, $Out> {
  GradeCopyWith<$R, Grade, $Out> get $asGrade =>
      $base.as((v, t, t2) => _GradeCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _GradeCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Grade, $Out>
  ...
  @override
  Grade $make(CopyWithData data) => Grade(
  ...
  GradeCopyWith<$R2, Grade, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _GradeCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
