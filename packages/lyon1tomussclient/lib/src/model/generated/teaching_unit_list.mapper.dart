...
class TeachingUnitListMapper extends ClassMapperBase<TeachingUnitList> {
  ...
  static const Field<TeachingUnitList, int> _f$semesterIndex = Field(
    'semesterIndex',
    _$semesterIndex,
  );

  @override
  final MappableFields<TeachingUnitList> fields = const {
  ...
  static TeachingUnitList _instantiate(DecodingData data) {
    return TeachingUnitList(
      data.dec(_f$teachingUnitModels),
      data.dec(_f$semesterIndex),
    );
  }
...
mixin TeachingUnitListMappable {
  ...
  get copyWith =>
      _TeachingUnitListCopyWithImpl<TeachingUnitList, TeachingUnitList>(
        this as TeachingUnitList,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return TeachingUnitListMapper.ensureInitialized().stringifyValue(
      this as TeachingUnitList,
    );
  }
  ...
  bool operator ==(Object other) {
    return TeachingUnitListMapper.ensureInitialized().equalsValue(
      this as TeachingUnitList,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TeachingUnitListMapper.ensureInitialized().hashValue(
      this as TeachingUnitList,
    );
  }
}
...
extension TeachingUnitListValueCopy<$R, $Out>
  ...
  get $asTeachingUnitList =>
      $base.as((v, t, t2) => _TeachingUnitListCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _TeachingUnitListCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
    ...
    TeachingUnitCopyWith<$R, TeachingUnit, TeachingUnit>
  >
  get teachingUnitModels => ListCopyWith(
    $value.teachingUnitModels,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(teachingUnitModels: v),
  );
  @override
  $R call({List<TeachingUnit>? teachingUnitModels, int? semesterIndex}) =>
      $apply(
        FieldCopyWithData({
          if (teachingUnitModels != null)
            #teachingUnitModels: teachingUnitModels,
  ...
  TeachingUnitListCopyWith<$R2, TeachingUnitList, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _TeachingUnitListCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
