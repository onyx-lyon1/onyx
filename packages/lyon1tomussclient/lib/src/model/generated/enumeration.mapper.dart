...
class EnumerationMapper extends ClassMapperBase<Enumeration> {
  EnumerationMapper._();
  ...
  static const Field<Enumeration, String> _f$title = Field('title', _$title);
  static String _$author(Enumeration v) => v.author;
  static const Field<Enumeration, String> _f$author = Field('author', _$author);
  static DateTime? _$date(Enumeration v) => v.date;
  static const Field<Enumeration, DateTime> _f$date = Field('date', _$date);
  static double _$position(Enumeration v) => v.position;
  static const Field<Enumeration, double> _f$position = Field(
    'position',
    _$position,
  );
  static String? _$value(Enumeration v) => v.value;
  static const Field<Enumeration, String> _f$value = Field(
    'value',
    _$value,
    opt: true,
  );
  static List<String> _$values(Enumeration v) => v.values;
  static const Field<Enumeration, List<String>> _f$values = Field(
    'values',
    _$values,
    opt: true,
    def: const [],
  ...
  static const Field<Enumeration, String> _f$comment = Field(
    'comment',
    _$comment,
    opt: true,
    def: "",
  ...
  static const Field<Enumeration, String> _f$theId = Field(
    'theId',
    _$theId,
    opt: true,
    def: "",
  ...
  static const Field<Enumeration, String> _f$lineId = Field(
    'lineId',
    _$lineId,
    opt: true,
    def: "",
  ...
  static const Field<Enumeration, String> _f$ue = Field(
    'ue',
    _$ue,
    opt: true,
    def: "",
  ...
  static const Field<Enumeration, String> _f$semester = Field(
    'semester',
    _$semester,
    opt: true,
    def: "",
  ...
  static const Field<Enumeration, String> _f$year = Field(
    'year',
    _$year,
    opt: true,
    def: "",
  ...
  static const Field<Enumeration, bool> _f$modifiable = Field(
    'modifiable',
    _$modifiable,
    opt: true,
    def: true,
  );
  static bool _$isVisible(Enumeration v) => v.isVisible;
  static const Field<Enumeration, bool> _f$isVisible = Field(
    'isVisible',
    _$isVisible,
    mode: FieldMode.member,
  );
  static List<Object?> _$customProps(Enumeration v) => v.customProps;
  static const Field<Enumeration, List<Object?>> _f$customProps = Field(
    'customProps',
    _$customProps,
    mode: FieldMode.member,
  );
  ...
  @override
  final MappableFields<Enumeration> fields = const {
    #title: _f$title,
    #author: _f$author,
    #date: _f$date,
...
mixin EnumerationMappable {
  String toJson() {
    return EnumerationMapper.ensureInitialized().encodeJson<Enumeration>(
      this as Enumeration,
    );
  }

  Map<String, dynamic> toMap() {
    return EnumerationMapper.ensureInitialized().encodeMap<Enumeration>(
      this as Enumeration,
    );
  }

  EnumerationCopyWith<Enumeration, Enumeration, Enumeration> get copyWith =>
      _EnumerationCopyWithImpl<Enumeration, Enumeration>(
        this as Enumeration,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return EnumerationMapper.ensureInitialized().stringifyValue(
      this as Enumeration,
    );
  }
  ...
  bool operator ==(Object other) {
    return EnumerationMapper.ensureInitialized().equalsValue(
      this as Enumeration,
      other,
    );
  }
...
extension EnumerationValueCopy<$R, $Out>
  ...
  EnumerationCopyWith<$R, Enumeration, $Out> get $asEnumeration =>
      $base.as((v, t, t2) => _EnumerationCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _EnumerationCopyWithImpl<$R, $Out>
  ...
  @override
  Enumeration $make(CopyWithData data) => Enumeration(
  ...
  EnumerationCopyWith<$R2, Enumeration, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _EnumerationCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
