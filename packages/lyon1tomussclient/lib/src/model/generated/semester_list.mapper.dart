...
class SemesterListMapper extends ClassMapperBase<SemesterList> {
  ...
  static const Field<SemesterList, List<Semester>> _f$semestres = Field(
    'semestres',
    _$semestres,
  );
  static int _$currentSemesterIndex(SemesterList v) => v.currentSemesterIndex;
  static const Field<SemesterList, int> _f$currentSemesterIndex = Field(
    'currentSemesterIndex',
    _$currentSemesterIndex,
    opt: true,
    def: 0,
  );

  @override
  final MappableFields<SemesterList> fields = const {
...
mixin SemesterListMappable {
  String toJson() {
    return SemesterListMapper.ensureInitialized().encodeJson<SemesterList>(
      this as SemesterList,
    );
  }

  Map<String, dynamic> toMap() {
    return SemesterListMapper.ensureInitialized().encodeMap<SemesterList>(
      this as SemesterList,
    );
  }

  SemesterListCopyWith<SemesterList, SemesterList, SemesterList> get copyWith =>
      _SemesterListCopyWithImpl<SemesterList, SemesterList>(
        this as SemesterList,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return SemesterListMapper.ensureInitialized().stringifyValue(
      this as SemesterList,
    );
  }
  ...
  bool operator ==(Object other) {
    return SemesterListMapper.ensureInitialized().equalsValue(
      this as SemesterList,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SemesterListMapper.ensureInitialized().hashValue(
      this as SemesterList,
    );
  }
}
...
extension SemesterListValueCopy<$R, $Out>
  ...
  SemesterListCopyWith<$R, SemesterList, $Out> get $asSemesterList =>
      $base.as((v, t, t2) => _SemesterListCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _SemesterListCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, Semester, SemesterCopyWith<$R, Semester, Semester>>
  get semestres => ListCopyWith(
    $value.semestres,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(semestres: v),
  );
  @override
  $R call({List<Semester>? semestres, int? currentSemesterIndex}) => $apply(
    FieldCopyWithData({
  ...
  @override
  SemesterList $make(CopyWithData data) => SemesterList(
    data.get(#semestres, or: $value.semestres),
    currentSemesterIndex: data.get(
      #currentSemesterIndex,
      or: $value.currentSemesterIndex,
    ),
  );
  ...
  SemesterListCopyWith<$R2, SemesterList, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _SemesterListCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
