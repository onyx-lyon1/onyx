...
class TeachingUnitMapper extends ClassMapperBase<TeachingUnit> {
  ...
  static const Field<TeachingUnit, String> _f$title = Field(
    'title',
    _$title,
    opt: true,
    def: "",
  ...
  static const Field<TeachingUnit, List<Teacher>> _f$masters = Field(
    'masters',
    _$masters,
    opt: true,
    def: const [],
  ...
  static const Field<TeachingUnit, List<Grade>> _f$grades = Field(
    'grades',
    _$grades,
    opt: true,
    def: const [],
  ...
  static const Field<TeachingUnit, List<TomussText>> _f$textValues = Field(
    'textValues',
    _$textValues,
    opt: true,
    def: const [],
  ...
  static const Field<TeachingUnit, List<Enumeration>> _f$enumerations = Field(
    'enumerations',
    _$enumerations,
    opt: true,
    def: const [],
  ...
  static const Field<TeachingUnit, List<Presence>> _f$presences = Field(
    'presences',
    _$presences,
    opt: true,
    def: const [],
  ...
  static const Field<TeachingUnit, List<StageCode>> _f$stageCodes = Field(
    'stageCodes',
    _$stageCodes,
    opt: true,
    def: const [],
  ...
  static const Field<TeachingUnit, List<Upload>> _f$uploads = Field(
    'uploads',
    _$uploads,
    opt: true,
    def: const [],
  ...
  static const Field<TeachingUnit, List<URL>> _f$urls = Field(
    'urls',
    _$urls,
    opt: true,
    def: const [],
  ...
  static const Field<TeachingUnit, String> _f$ticket = Field(
    'ticket',
    _$ticket,
    opt: true,
    def: "",
  ...
  static const Field<TeachingUnit, String> _f$ue = Field(
    'ue',
    _$ue,
    opt: true,
    def: "",
...
mixin TeachingUnitMappable {
  String toJson() {
    return TeachingUnitMapper.ensureInitialized().encodeJson<TeachingUnit>(
      this as TeachingUnit,
    );
  }

  Map<String, dynamic> toMap() {
    return TeachingUnitMapper.ensureInitialized().encodeMap<TeachingUnit>(
      this as TeachingUnit,
    );
  }

  TeachingUnitCopyWith<TeachingUnit, TeachingUnit, TeachingUnit> get copyWith =>
      _TeachingUnitCopyWithImpl<TeachingUnit, TeachingUnit>(
        this as TeachingUnit,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return TeachingUnitMapper.ensureInitialized().stringifyValue(
      this as TeachingUnit,
    );
  }
  ...
  bool operator ==(Object other) {
    return TeachingUnitMapper.ensureInitialized().equalsValue(
      this as TeachingUnit,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TeachingUnitMapper.ensureInitialized().hashValue(
      this as TeachingUnit,
    );
  }
}
...
extension TeachingUnitValueCopy<$R, $Out>
  ...
  TeachingUnitCopyWith<$R, TeachingUnit, $Out> get $asTeachingUnit =>
      $base.as((v, t, t2) => _TeachingUnitCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _TeachingUnitCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<
    ...
    EnumerationCopyWith<$R, Enumeration, Enumeration>
  >
  get enumerations => ListCopyWith(
    $value.enumerations,
    (v, t) => v.copyWith.$chain(t),
    (v) => call(enumerations: v),
  );
  @override
  ListCopyWith<$R, Presence, PresenceCopyWith<$R, Presence, Presence>>
  ...
  @override
  TeachingUnit $make(CopyWithData data) => TeachingUnit(
  ...
  TeachingUnitCopyWith<$R2, TeachingUnit, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _TeachingUnitCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
