...
class TeacherMapper extends ClassMapperBase<Teacher> {
  ...
  static const Field<Teacher, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
    def: "",
  ...
  static const Field<Teacher, String> _f$email = Field(
    'email',
    _$email,
    opt: true,
    def: "",
  ...
  @override
  final MappableFields<Teacher> fields = const {
    #name: _f$name,
    #email: _f$email,
  };

  static Teacher _instantiate(DecodingData data) {
    return Teacher(name: data.dec(_f$name), email: data.dec(_f$email));
  }
...
mixin TeacherMappable {
  String toJson() {
    return TeacherMapper.ensureInitialized().encodeJson<Teacher>(
      this as Teacher,
    );
  }

  Map<String, dynamic> toMap() {
    return TeacherMapper.ensureInitialized().encodeMap<Teacher>(
      this as Teacher,
    );
  }

  TeacherCopyWith<Teacher, Teacher, Teacher> get copyWith =>
      _TeacherCopyWithImpl<Teacher, Teacher>(
        this as Teacher,
        $identity,
        $identity,
      );
  ...
  bool operator ==(Object other) {
    return TeacherMapper.ensureInitialized().equalsValue(
      this as Teacher,
      other,
    );
  }
...
extension TeacherValueCopy<$R, $Out> on ObjectCopyWith<$R, Teacher, $Out> {
  TeacherCopyWith<$R, Teacher, $Out> get $asTeacher =>
      $base.as((v, t, t2) => _TeacherCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _TeacherCopyWithImpl<$R, $Out>
  ...
  @override
  Teacher $make(CopyWithData data) => Teacher(
  ...
  TeacherCopyWith<$R2, Teacher, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _TeacherCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
