...
class UploadMapper extends ClassMapperBase<Upload> {
  ...
  static const Field<Upload, String> _f$title = Field('title', _$title);
  static String _$author(Upload v) => v.author;
  static const Field<Upload, String> _f$author = Field('author', _$author);
  static DateTime? _$date(Upload v) => v.date;
  static const Field<Upload, DateTime> _f$date = Field('date', _$date);
  static double _$position(Upload v) => v.position;
  static const Field<Upload, double> _f$position = Field(
    'position',
    _$position,
  );
  static String _$comment(Upload v) => v.comment;
  static const Field<Upload, String> _f$comment = Field(
    'comment',
    _$comment,
    opt: true,
    def: "",
  ...
  static const Field<Upload, int> _f$uploadMax = Field(
    'uploadMax',
    _$uploadMax,
    opt: true,
    def: 0,
  ...
  static const Field<Upload, String> _f$fileUrl = Field(
    'fileUrl',
    _$fileUrl,
    opt: true,
    def: "",
  );
  static bool _$isVisible(Upload v) => v.isVisible;
  static const Field<Upload, bool> _f$isVisible = Field(
    'isVisible',
    _$isVisible,
    mode: FieldMode.member,
  );
  static List<Object?> _$customProps(Upload v) => v.customProps;
  static const Field<Upload, List<Object?>> _f$customProps = Field(
    'customProps',
    _$customProps,
    mode: FieldMode.member,
  );
