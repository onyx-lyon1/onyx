...
class CredentialMapper extends ClassMapperBase<Credential> {
  ...
  static const Field<Credential, String> _f$username = Field(
    'username',
    _$username,
  );
  static String _$password(Credential v) => v.password;
  static const Field<Credential, String> _f$password = Field(
    'password',
    _$password,
  );
  static String _$tgcToken(Credential v) => v.tgcToken;
  static const Field<Credential, String> _f$tgcToken = Field(
    'tgcToken',
    _$tgcToken,
    opt: true,
    def: "",
  ...
  @override
  final MappableFields<Credential> fields = const {
...
mixin CredentialMappable {
  String toJson() {
    return CredentialMapper.ensureInitialized().encodeJson<Credential>(
      this as Credential,
    );
  }

  Map<String, dynamic> toMap() {
    return CredentialMapper.ensureInitialized().encodeMap<Credential>(
      this as Credential,
    );
  }

  CredentialCopyWith<Credential, Credential, Credential> get copyWith =>
      _CredentialCopyWithImpl<Credential, Credential>(
        this as Credential,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return CredentialMapper.ensureInitialized().stringifyValue(
      this as Credential,
    );
  }
  ...
  bool operator ==(Object other) {
    return CredentialMapper.ensureInitialized().equalsValue(
      this as Credential,
      other,
    );
  }
...
extension CredentialValueCopy<$R, $Out>
  ...
  CredentialCopyWith<$R, Credential, $Out> get $asCredential =>
      $base.as((v, t, t2) => _CredentialCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _CredentialCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? username, String? password, String? tgcToken}) => $apply(
    FieldCopyWithData({
  ...
  CredentialCopyWith<$R2, Credential, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _CredentialCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
