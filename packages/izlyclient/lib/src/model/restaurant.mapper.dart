...
extension CrousTypeMapperExtension on CrousType {
  dynamic toValue() {
    ...
    return MapperContainer.globals.toValue<CrousType>(this);
  }
}
...
class RestaurantModelMapper extends ClassMapperBase<RestaurantModel> {
  ...
  static const Field<RestaurantModel, String> _f$shortDescription =
      Field('shortDescription', _$shortDescription);
  static CrousType _$type(RestaurantModel v) => v.type;
  static const Field<RestaurantModel, CrousType> _f$type =
      Field('type', _$type);
  ...
  static const Field<RestaurantModel, String> _f$opening =
      Field('opening', _$opening);
  static List<MenuCrous> _$menus(RestaurantModel v) => v.menus;
  static const Field<RestaurantModel, List<MenuCrous>> _f$menus =
      Field('menus', _$menus);
  static String _$imageUrl(RestaurantModel v) => v.imageUrl;
  static const Field<RestaurantModel, String> _f$imageUrl =
