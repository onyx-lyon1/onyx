...
class MenuCrousMapper extends ClassMapperBase<MenuCrous> {
  ...
  static const Field<MenuCrous, List<PlatCrous>> _f$plats = Field(
    'plats',
    _$plats,
  );

  @override
  final MappableFields<MenuCrous> fields = const {
    #date: _f$date,
    #type: _f$type,
    #plats: _f$plats,
  };
...
mixin MenuCrousMappable {
  String toJson() {
    return MenuCrousMapper.ensureInitialized().encodeJson<MenuCrous>(
      this as MenuCrous,
    );
  }

  Map<String, dynamic> toMap() {
    return MenuCrousMapper.ensureInitialized().encodeMap<MenuCrous>(
      this as MenuCrous,
    );
  }

  MenuCrousCopyWith<MenuCrous, MenuCrous, MenuCrous> get copyWith =>
      _MenuCrousCopyWithImpl<MenuCrous, MenuCrous>(
        this as MenuCrous,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return MenuCrousMapper.ensureInitialized().stringifyValue(
      this as MenuCrous,
    );
  }
  ...
  bool operator ==(Object other) {
    return MenuCrousMapper.ensureInitialized().equalsValue(
      this as MenuCrous,
      other,
    );
  }
...
extension MenuCrousValueCopy<$R, $Out> on ObjectCopyWith<$R, MenuCrous, $Out> {
  MenuCrousCopyWith<$R, MenuCrous, $Out> get $asMenuCrous =>
      $base.as((v, t, t2) => _MenuCrousCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _MenuCrousCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({DateTime? date, MenuType? type, List<PlatCrous>? plats}) => $apply(
    FieldCopyWithData({
  ...
  MenuCrousCopyWith<$R2, MenuCrous, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _MenuCrousCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
...
class PlatCrousMapper extends ClassMapperBase<PlatCrous> {
  ...
  static const Field<PlatCrous, List<String>> _f$variants = Field(
    'variants',
    _$variants,
  );

  @override
  final MappableFields<PlatCrous> fields = const {
    #name: _f$name,
...
mixin PlatCrousMappable {
  String toJson() {
    return PlatCrousMapper.ensureInitialized().encodeJson<PlatCrous>(
      this as PlatCrous,
    );
  }

  Map<String, dynamic> toMap() {
    return PlatCrousMapper.ensureInitialized().encodeMap<PlatCrous>(
      this as PlatCrous,
    );
  }

  PlatCrousCopyWith<PlatCrous, PlatCrous, PlatCrous> get copyWith =>
      _PlatCrousCopyWithImpl<PlatCrous, PlatCrous>(
        this as PlatCrous,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return PlatCrousMapper.ensureInitialized().stringifyValue(
      this as PlatCrous,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return PlatCrousMapper.ensureInitialized().equalsValue(
      this as PlatCrous,
      other,
    );
  }
...
extension PlatCrousValueCopy<$R, $Out> on ObjectCopyWith<$R, PlatCrous, $Out> {
  PlatCrousCopyWith<$R, PlatCrous, $Out> get $asPlatCrous =>
      $base.as((v, t, t2) => _PlatCrousCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _PlatCrousCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? name, List<String>? variants}) => $apply(
    FieldCopyWithData({
  ...
  PlatCrousCopyWith<$R2, PlatCrous, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _PlatCrousCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
