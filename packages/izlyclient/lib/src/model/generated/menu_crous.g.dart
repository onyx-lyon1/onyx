...
class MenuRegimeAdapter extends TypeAdapter<MenuRegime> {
  @override
  final int typeId = 35;

  @override
  MenuRegime read(BinaryReader reader) {
    switch (reader.readByte()) {
      case 0:
        return MenuRegime.normal;
      case 1:
        return MenuRegime.vegetarian;
      case 2:
        return MenuRegime.vegan;
      case 3:
        return MenuRegime.sansPorc;
      case 4:
        return MenuRegime.sansViande;
      case 5:
        return MenuRegime.sansPorcNiViande;
      default:
        return MenuRegime.normal;
    }
  }
  ...
  @override
  void write(BinaryWriter writer, MenuRegime obj) {
    switch (obj) {
      case MenuRegime.normal:
        writer.writeByte(0);
        break;
      case MenuRegime.vegetarian:
        writer.writeByte(1);
        break;
      case MenuRegime.vegan:
        writer.writeByte(2);
        break;
      case MenuRegime.sansPorc:
        writer.writeByte(3);
        break;
      case MenuRegime.sansViande:
        writer.writeByte(4);
        break;
      case MenuRegime.sansPorcNiViande:
        writer.writeByte(5);
        break;
    }
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is MenuRegimeAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}

class MenuCrousTypeAdapter extends TypeAdapter<MenuCrousType> {
  @override
  final int typeId = 37;

  @override
  MenuCrousType read(BinaryReader reader) {
    switch (reader.readByte()) {
      case 0:
        return MenuCrousType.entree;
      case 1:
        return MenuCrousType.plat;
      case 2:
        return MenuCrousType.dessert;
      case 3:
        return MenuCrousType.sandwich;
      case 4:
        return MenuCrousType.salade;
      default:
        return MenuCrousType.entree;
    }
  }
  ...
  @override
  void write(BinaryWriter writer, MenuCrousType obj) {
    switch (obj) {
      case MenuCrousType.entree:
        writer.writeByte(0);
        break;
      case MenuCrousType.plat:
        writer.writeByte(1);
        break;
      case MenuCrousType.dessert:
        writer.writeByte(2);
        break;
      case MenuCrousType.sandwich:
        writer.writeByte(3);
        break;
      case MenuCrousType.salade:
        writer.writeByte(4);
        break;
    }
  }
