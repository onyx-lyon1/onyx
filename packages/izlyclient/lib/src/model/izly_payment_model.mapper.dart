...
class IzlyPaymentModelMapper extends ClassMapperBase<IzlyPaymentModel> {
  ...
  static String _$paymentTime(IzlyPaymentModel v) => v.paymentTime;
  static const Field<IzlyPaymentModel, String> _f$paymentTime =
      Field('paymentTime', _$paymentTime);
  static String _$amountSpent(IzlyPaymentModel v) => v.amountSpent;
  static const Field<IzlyPaymentModel, String> _f$amountSpent =
      Field('amountSpent', _$amountSpent);
  static bool _$isSucess(IzlyPaymentModel v) => v.isSucess;
  static const Field<IzlyPaymentModel, bool> _f$isSucess =
      Field('isSucess', _$isSucess);

  @override
  final Map<Symbol, Field<IzlyPaymentModel, dynamic>> fields = const {
...
mixin IzlyPaymentModelMappable {
  ...
  IzlyPaymentModelCopyWith<IzlyPaymentModel, IzlyPaymentModel, IzlyPaymentModel>
      get copyWith => _IzlyPaymentModelCopyWithImpl(
          this as IzlyPaymentModel, $identity, $identity);
  @override
  String toString() {
    return IzlyPaymentModelMapper.ensureInitialized()
        .stringifyValue(this as IzlyPaymentModel);
  }
    ...
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            IzlyPaymentModelMapper.ensureInitialized()
                .isValueEqual(this as IzlyPaymentModel, other));
  }

  @override
  int get hashCode {
    return IzlyPaymentModelMapper.ensureInitialized()
        .hashValue(this as IzlyPaymentModel);
  }
}
...
extension IzlyPaymentModelValueCopy<$R, $Out>
  ...
  IzlyPaymentModelCopyWith<$R, IzlyPaymentModel, $Out>
      get $asIzlyPaymentModel =>
          $base.as((v, t, t2) => _IzlyPaymentModelCopyWithImpl(v, t, t2));
}

abstract class IzlyPaymentModelCopyWith<$R, $In extends IzlyPaymentModel, $Out>
    implements ClassCopyWith<$R, $In, $Out> {
  $R call({String? paymentTime, String? amountSpent, bool? isSucess});
...
class _IzlyPaymentModelCopyWithImpl<$R, $Out>
  ...
  IzlyPaymentModelCopyWith<$R2, IzlyPaymentModel, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _IzlyPaymentModelCopyWithImpl($value, $cast, t);
}
