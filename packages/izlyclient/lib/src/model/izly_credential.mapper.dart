...
class IzlyCredentialMapper extends ClassMapperBase<IzlyCredential> {
  ...
  static const Field<IzlyCredential, String> _f$username =
      Field('username', _$username);
  static String _$password(IzlyCredential v) => v.password;
  static const Field<IzlyCredential, String> _f$password =
      Field('password', _$password);

  @override
  final Map<Symbol, Field<IzlyCredential, dynamic>> fields = const {
...
mixin IzlyCredentialMappable {
  ...
  IzlyCredentialCopyWith<IzlyCredential, IzlyCredential, IzlyCredential>
      get copyWith => _IzlyCredentialCopyWithImpl(
          this as IzlyCredential, $identity, $identity);
  @override
  String toString() {
    return IzlyCredentialMapper.ensureInitialized()
        .stringifyValue(this as IzlyCredential);
  }
    ...
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            IzlyCredentialMapper.ensureInitialized()
                .isValueEqual(this as IzlyCredential, other));
  }

  @override
  int get hashCode {
    return IzlyCredentialMapper.ensureInitialized()
        .hashValue(this as IzlyCredential);
  }
}
...
extension IzlyCredentialValueCopy<$R, $Out>
  ...
  IzlyCredentialCopyWith<$R, IzlyCredential, $Out> get $asIzlyCredential =>
      $base.as((v, t, t2) => _IzlyCredentialCopyWithImpl(v, t, t2));
}
...
class _IzlyCredentialCopyWithImpl<$R, $Out>
  ...
  IzlyCredentialCopyWith<$R2, IzlyCredential, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _IzlyCredentialCopyWithImpl($value, $cast, t);
}
