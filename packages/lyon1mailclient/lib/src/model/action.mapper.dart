...
class ActionMapper extends ClassMapperBase<Action> {
  ...
  static const Field<Action, MailBox> _f$fromMailBox =
      Field('fromMailBox', _$fromMailBox, opt: true);
  static int? _$originalMessageId(Action v) => v.originalMessageId;
  static const Field<Action, int> _f$originalMessageId =
      Field('originalMessageId', _$originalMessageId, opt: true);
  static bool? _$replyAll(Action v) => v.replyAll;
  static const Field<Action, bool> _f$replyAll =
      Field('replyAll', _$replyAll, opt: true);
  static MailBox? _$destinationMailBox(Action v) => v.destinationMailBox;
  static const Field<Action, MailBox> _f$destinationMailBox =
      Field('destinationMailBox', _$destinationMailBox, opt: true);

  @override
  final Map<Symbol, Field<Action, dynamic>> fields = const {
    #type: _f$type,
    #mail: _f$mail,
...
mixin ActionMappable {
  ...
  ActionCopyWith<Action, Action, Action> get copyWith =>
      _ActionCopyWithImpl(this as Action, $identity, $identity);
  @override
  String toString() {
    ...
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            ActionMapper.ensureInitialized()
                .isValueEqual(this as Action, other));
  }
...
extension ActionValueCopy<$R, $Out> on ObjectCopyWith<$R, Action, $Out> {
  ActionCopyWith<$R, Action, $Out> get $asAction =>
      $base.as((v, t, t2) => _ActionCopyWithImpl(v, t, t2));
}
...
class _ActionCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Action, $Out>
  ...
  Action $make(CopyWithData data) => Action(
      ...
      originalMessageId:
          data.get(#originalMessageId, or: $value.originalMessageId),
      replyAll: data.get(#replyAll, or: $value.replyAll),
      destinationMailBox:
          data.get(#destinationMailBox, or: $value.destinationMailBox));

  @override
  ActionCopyWith<$R2, Action, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _ActionCopyWithImpl($value, $cast, t);
}
