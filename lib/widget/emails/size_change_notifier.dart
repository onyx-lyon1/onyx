...
class LayoutSizeChangeNotifier extends SingleChildRenderObjectWidget {
  ...
  @override
  SizeChangeRenderWithCallback createRenderObject(BuildContext context) {
    return SizeChangeRenderWithCallback(
...
class SizeChangeRenderWithCallback extends RenderProxyBox {
  SizeChangeRenderWithCallback({
    RenderBox? child,
